...
const config: Config = {
  ...
  themeConfig: {
    metadata: [
      ...
      // Open Graph
      { property: "og:title", content: "Suites - Modern Testing Meta-Framework" },
      {
      ...
      { property: "og:image:alt", content: "Suites - Modern Testing Meta-Framework" },
      ...
      { name: "twitter:title", content: "Suites - Modern Testing Meta-Framework" },
      {
