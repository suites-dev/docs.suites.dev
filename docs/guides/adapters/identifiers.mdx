...
description: Working with class and token-based dependency injection
---
...
:::tip
See the full installation guide [here](/docs/get-started/installation)
:::
...
Currently, only the InversifyJS adapter supports metadata. For more information, visit the [InversifyJS documentation](/docs/guides/adapters/inversifyjs) page.

## Next Steps

- [**InversifyJS Guide**](/docs/guides/adapters/inversifyjs) - Learn about advanced identifier patterns in InversifyJS
