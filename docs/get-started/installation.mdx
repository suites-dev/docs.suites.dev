...
sidebar_position: 3
title: Installation
description: Learn how to install and configure Suites to enhance your unit testing process across frameworks implementing IoC and various testing libraries.
---
...
<div class="next-steps-section">
  ...
  After installing Suites, the first test can be written.
  Check out the [Quick Start](/docs/get-started/quickstart) guide to write the first test, or explore the [Guides](/docs/guides/) section for testing patterns.
