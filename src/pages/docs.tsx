    ...
    <div className={`container ${styles.docs}`}>
      <div className={"row"} style={{ padding: "10px" }}>
        ...
        <p>
          <strong>
            Suites is a{" "}
            <a href="/docs/overview/what-is-suites#suites-as-a-meta-framework">
              progressive, flexible unit-testing framework
            </a>{" "}
            aimed at elevating the software testing experience within backend
            systems working with dependency injection frameworks.
          </strong>
        </p>
        <p>
          Suites provides a unified testing experience that combines best
          practices, industry standards, and a wide range of testing tools to
          help developers create robust, maintainable, and scalable test suites,
      ...
      <div className={"row"} style={{ marginTop: 50 }}>
        ...
        <p>
          Suites works seamlessly with popular mocking libraries and dependency
          injection frameworks. This means that you can leverage the full power
          of these libraries and frameworks while enjoying the convenience and
          flexibility that Suites provides.
        </p>
        <Libraries />
      </div>
      ...
      <div className={"row"} style={{ marginTop: "50px", padding: "0 20px" }}>
        ...
        <p>
          <Link to="/docs/developer-guide/unit-tests/suites-api">
            Suites offers a fluent, convenient, and semantic API
          </Link>{" "}
          that makes writing tests a pleasure. The intuitive design of the API
          ensures that you can quickly set up your tests and focus on verifying
  ...
  it('should generate a random user and save to the database', async () => {
    ...
    expect(database.saveUser).toHaveBeenCalledWith(userFixture);
      ...
      <div className={"row"} style={{ marginTop: 20 }}>
        ...
        <p>
          Ready to get started with Suites? Check out the{" "}
          <Link to="/docs/overview/">documentation overview</Link> to learn more
          about Suites and how you can use it to improve your testing
          experience.
        </p>
      </div>
    </div>
    ...
    <div className={`container ${styles.libraries}`}>
      ...
      >
        {libraries.map((props, idx) => (
          <div
            key={idx}
            className={`col col--2 ${styles.library}`}
